        ...
        extends TestAnnotationEngine
{
    ...
    public void testMultiOutputAggregationParse()
    {
        ...
        ParametricAggregation aggregation1 = aggregations.stream().filter(aggregate -> "multi_output_aggregate_1".equals(aggregate.getSignature().getNameSuffix())).collect(toImmutableList()).get(0);
        ...
        ParametricAggregation aggregation2 = aggregations.stream().filter(aggregate -> "multi_output_aggregate_2".equals(aggregate.getSignature().getNameSuffix())).collect(toImmutableList()).get(0);
