...
{
    private static final Logger logger = LoggerFactory.getLogger(SplitGenerators.class);
    ...
    public static void main(String[] args)
    {
        ...
        logger.info("Scheduled time distributions");
        logger.info("============================");
        System.out.println();
        logger.info("Tasks with 8x " + IntermediateSplitGenerator.class.getSimpleName());
        ...
        leafSplitGenerators.forEach(generator -> {
