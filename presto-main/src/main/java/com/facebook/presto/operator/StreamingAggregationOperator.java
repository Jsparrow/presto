        ...
        implements Operator
{
	...
	private List<Aggregator> setupAggregates(Step step, List<AccumulatorFactory> accumulatorFactories)
    {
        ...
        accumulatorFactories.forEach(factory -> builder.add(new Aggregator(factory, step)));
    ...
    {
        aggregates.forEach(aggregator -> aggregator.processPage(page.getRegion(startPosition, endPosition - startPosition + 1)));
    }
