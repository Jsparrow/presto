        ...
        extends ProductTest
{
    ...
    public void testStatisticsForUnpartitionedTable()
    {
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" COMPUTE STATISTICS").toString());
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" COMPUTE STATISTICS FOR COLUMNS").toString());
    ...
    public void testStatisticsForTablePartitionedByBigint()
    {
        ...
        String showStatsWholeTable = "SHOW STATS FOR " + tableNameInDatabase;
        String showStatsPartitionOne = new StringBuilder().append("SHOW STATS FOR (SELECT * FROM ").append(tableNameInDatabase).append(" WHERE p_regionkey = 1)").toString();
        String showStatsPartitionTwo = new StringBuilder().append("SHOW STATS FOR (SELECT * FROM ").append(tableNameInDatabase).append(" WHERE p_regionkey = 2)").toString();
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" PARTITION (p_regionkey = \"1\") COMPUTE STATISTICS").toString());
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" PARTITION (p_regionkey) COMPUTE STATISTICS").toString());
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" PARTITION (p_regionkey = \"1\") COMPUTE STATISTICS FOR COLUMNS").toString());
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" PARTITION (p_regionkey) COMPUTE STATISTICS FOR COLUMNS").toString());
    ...
    public void testStatisticsForTablePartitionedByVarchar()
    {
        ...
        String showStatsWholeTable = "SHOW STATS FOR " + tableNameInDatabase;
        String showStatsPartitionOne = new StringBuilder().append("SHOW STATS FOR (SELECT * FROM ").append(tableNameInDatabase).append(" WHERE p_regionkey = 'AMERICA')").toString();
        String showStatsPartitionTwo = new StringBuilder().append("SHOW STATS FOR (SELECT * FROM ").append(tableNameInDatabase).append(" WHERE p_regionkey = 'ASIA')").toString();
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" PARTITION (p_regionkey = \"AMERICA\") COMPUTE STATISTICS").toString());
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableNameInDatabase).append(" PARTITION (p_regionkey = \"AMERICA\") COMPUTE STATISTICS FOR COLUMNS").toString());
    ...
    {
        String tableNameInDatabase = mutableTablesState().get(EMPTY_ALL_TYPES_TABLE_NAME).getNameInDatabase();
        onHive().executeQuery(new StringBuilder().append("INSERT INTO TABLE ").append(tableNameInDatabase).append(" VALUES(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null)").toString());
    ...
    public void testStatisticsForSkewedTable()
    {
        ...
        onHive().executeQuery(new StringBuilder().append("CREATE TABLE ").append(tableName).append(" (c_string STRING, c_int INT) SKEWED BY (c_string) ON ('c1')").toString());
        onHive().executeQuery(new StringBuilder().append("INSERT INTO TABLE ").append(tableName).append(" VALUES ('c1', 1), ('c1', 2)").toString());
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableName).append(" COMPUTE STATISTICS").toString());
        ...
        onHive().executeQuery(new StringBuilder().append("ANALYZE TABLE ").append(tableName).append(" COMPUTE STATISTICS FOR COLUMNS").toString());
        assertThat(query("SHOW STATS FOR " + tableName)).containsOnly(
    ...
    public void testAnalyzeForTablePartitionedByBigint()
    {
        ...
        assertThat(query(new StringBuilder().append("ANALYZE ").append(tableNameInDatabase).append(" WITH (partitions = ARRAY[ARRAY['1']])").toString())).containsExactly(row(5));
    ...
    public void testAnalyzeForTablePartitionedByVarchar()
    {
        ...
        assertThat(query(new StringBuilder().append("ANALYZE ").append(tableNameInDatabase).append(" WITH (partitions = ARRAY[ARRAY['AMERICA']])").toString())).containsExactly(row(5));
    ...
    public void testComputeTableStatisticsOnInsert()
    {
        ...
        try {
            ...
            query(format(new StringBuilder().append("INSERT INTO %s VALUES( ").append("TINYINT '120', ").append("SMALLINT '32760', ").append("INTEGER '2147483640', ").append("BIGINT '9223372036854775800', ").append("REAL '123.340', ").append("DOUBLE '234.560', ").append("CAST(343.0 AS DECIMAL(10, 0)), ")
					.append("CAST(345.670 AS DECIMAL(10, 5)), ").append("TIMESTAMP '2015-05-10 12:15:30', ").append("DATE '2015-05-08', ").append("CAST('ela ma kot' AS VARCHAR), ").append("CAST('ela ma ko' AS VARCHAR(10)), ").append("CAST('ela m     ' AS CHAR(10)), ").append("false, ").append("CAST('cGllcyBiaW5hcm54' as VARBINARY))").toString(), tableName));
    ...
    public void testComputePartitionStatisticsOnCreateTable()
    {
        ...
        query(format("DROP TABLE IF EXISTS %s", tableName));
        try {
            query(format(new StringBuilder().append("CREATE TABLE %s WITH ( ").append(" partitioned_by = ARRAY['p_bigint', 'p_varchar']").append(") AS ").append("SELECT * FROM ( ").append("    VALUES ").append("        (").append("           TINYINT '120', ").append("           SMALLINT '32760', ")
					.append("           INTEGER '2147483640', ").append("           BIGINT '9223372036854775800', ").append("           REAL '123.340', DOUBLE '234.560', ").append("           CAST(343.0 AS DECIMAL(10, 0)), ").append("           CAST(345.670 AS DECIMAL(10, 5)), ").append("           TIMESTAMP '2015-05-10 12:15:30', ").append("           DATE '2015-05-08', ").append("           CAST('p1 varchar' AS VARCHAR), ").append("           CAST('p1 varchar10' AS VARCHAR(10)), ")
					.append("           CAST('p1 char10' AS CHAR(10)), false, ").append("           CAST('p1 binary' as VARBINARY), ").append("           BIGINT '1', ").append("           CAST('partition1' AS VARCHAR)").append("        ), ").append("        (null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, BIGINT '1', 'partition1'), ").append("        (").append("           TINYINT '99', ").append("           SMALLINT '333',")
					.append("           INTEGER '444', ").append("           BIGINT '555', ").append("           REAL '666.340', ").append("           DOUBLE '777.560', ").append("           CAST(888.0 AS DECIMAL(10, 0)), ").append("           CAST(999.670 AS DECIMAL(10, 5)), ").append("           TIMESTAMP '2015-05-10 12:45:30', ").append("           DATE '2015-05-09', ").append("           CAST('p2 varchar' AS VARCHAR), ")
					.append("           CAST('p2 varchar10' AS VARCHAR(10)), ").append("           CAST('p2 char10' AS CHAR(10)), ").append("           true, ").append("           CAST('p2 binary' as VARBINARY), ").append("           BIGINT '2', ").append("           CAST('partition2' AS VARCHAR)").append("        ), ").append("        (null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, BIGINT '2', 'partition2') ").append("")
					.append(") AS t (c_tinyint, c_smallint, c_int, c_bigint, c_float, c_double, c_decimal, c_decimal_w_params, c_timestamp, c_date, c_string, c_varchar, c_char, c_boolean, c_binary, p_bigint, p_varchar)").toString(), tableName));
    ...
    public void testComputePartitionStatisticsOnInsert()
    {
        ...
        query(format("DROP TABLE IF EXISTS %s", tableName));
        try {
            query(format(new StringBuilder().append("CREATE TABLE %s(").append("c_tinyint            TINYINT, ").append("c_smallint           SMALLINT, ").append("c_int                INT, ").append("c_bigint             BIGINT, ").append("c_float              REAL, ").append("c_double             DOUBLE, ").append("c_decimal            DECIMAL(10,0), ")
					.append("c_decimal_w_params   DECIMAL(10,5), ").append("c_timestamp          TIMESTAMP, ").append("c_date               DATE, ").append("c_string             VARCHAR, ").append("c_varchar            VARCHAR(10), ").append("c_char               CHAR(10), ").append("c_boolean            BOOLEAN, ").append("c_binary             VARBINARY, ").append("p_bigint             BIGINT, ")
					.append("p_varchar            VARCHAR ").append(") WITH ( ").append(" partitioned_by = ARRAY['p_bigint', 'p_varchar']").append(")").toString(), tableName));

            query(format(new StringBuilder().append("INSERT INTO %s VALUES ").append("(TINYINT '120', SMALLINT '32760', INTEGER '2147483640', BIGINT '9223372036854775800', REAL '123.340', DOUBLE '234.560', CAST(343.0 AS DECIMAL(10, 0)), CAST(345.670 AS DECIMAL(10, 5)), TIMESTAMP '2015-05-10 12:15:30', DATE '2015-05-08', 'p1 varchar', CAST('p1 varchar10' AS VARCHAR(10)), CAST('p1 char10' AS CHAR(10)), false, CAST('p1 binary' as VARBINARY), BIGINT '1', 'partition1'),").append("(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, BIGINT '1', 'partition1')").toString(), tableName));

            query(format(new StringBuilder().append("INSERT INTO %s VALUES ").append("(TINYINT '99', SMALLINT '333', INTEGER '444', BIGINT '555', REAL '666.340', DOUBLE '777.560', CAST(888.0 AS DECIMAL(10, 0)), CAST(999.670 AS DECIMAL(10, 5)), TIMESTAMP '2015-05-10 12:45:30', DATE '2015-05-09', 'p2 varchar', CAST('p2 varchar10' AS VARCHAR(10)), CAST('p2 char10' AS CHAR(10)), true, CAST('p2 binary' as VARBINARY), BIGINT '2', 'partition2'),").append("(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, BIGINT '2', 'partition2')").toString(), tableName));
