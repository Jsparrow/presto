        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testShowStats()
    {
        assertQuery("SHOW STATS FOR nation_partitioned",
                new StringBuilder().append("SELECT * FROM (VALUES ").append("   ('regionkey', null, 5.0, 0.0, null, 0, 4), ").append("   ('nationkey', null, 5.0, 0.0, null, 0, 24), ").append("   ('name', 177.0, 5.0, 0.0, null, null, null), ").append("   ('comment', 1857.0, 5.0, 0.0, null, null, null), ").append("   (null, null, null, null, 25.0, null, null))").toString());
        ...
        assertQuery("SHOW STATS FOR (SELECT * FROM nation_partitioned WHERE regionkey IS NULL)",
                new StringBuilder().append("SELECT * FROM (VALUES ").append("   ('regionkey', null, 0.0, 0.0, null, null, null), ").append("   ('nationkey', null, 0.0, 0.0, null, null, null), ").append("   ('name', 0.0, 0.0, 0.0, null, null, null), ").append("   ('comment', 0.0, 0.0, 0.0, null, null, null), ").append("   (null, null, null, null, 0.0, null, null))").toString());

        assertQuery("SHOW STATS FOR (SELECT * FROM nation_partitioned WHERE regionkey = 1)",
                new StringBuilder().append("SELECT * FROM (VALUES ").append("   ('regionkey', null, 1.0, 0.0, null, 1, 1), ").append("   ('nationkey', null, 5.0, 0.0, null, 1, 24), ").append("   ('name', 38.0, 5.0, 0.0, null, null, null), ").append("   ('comment', 500.0, 5.0, 0.0, null, null, null), ").append("   (null, null, null, null, 5.0, null, null))").toString());

        assertQuery("SHOW STATS FOR (SELECT * FROM nation_partitioned WHERE regionkey IN (1, 3))",
                new StringBuilder().append("SELECT * FROM (VALUES ").append("   ('regionkey', null, 2.0, 0.0, null, 1, 3), ").append("   ('nationkey', null, 5.0, 0.0, null, 1, 24), ").append("   ('name', 78.0, 5.0, 0.0, null, null, null), ").append("   ('comment', 847.0, 5.0, 0.0, null, null, null), ").append("   (null, null, null, null, 10.0, null, null))").toString());

        assertQuery("SHOW STATS FOR (SELECT * FROM nation_partitioned WHERE regionkey BETWEEN 1 AND 1 + 2)",
                new StringBuilder().append("SELECT * FROM (VALUES ").append("   ('regionkey', null, 3.0, 0.0, null, 1, 3), ").append("   ('nationkey', null, 5.0, 0.0, null, 1, 24), ").append("   ('name', 109.0, 5.0, 0.0, null, null, null), ").append("   ('comment', 1199.0, 5.0, 0.0, null, null, null), ").append("   (null, null, null, null, 15.0, null, null))").toString());

        assertQuery("SHOW STATS FOR (SELECT * FROM nation_partitioned WHERE regionkey > 3)",
                new StringBuilder().append("SELECT * FROM (VALUES ").append("   ('regionkey', null, 1.0, 0.0, null, 4, 4), ").append("   ('nationkey', null, 5.0, 0.0, null, 4, 20), ").append("   ('name', 31.0, 5.0, 0.0, null, null, null), ").append("   ('comment', 348.0, 5.0, 0.0, null, null, null), ").append("   (null, null, null, null, 5.0, null, null))").toString());

        assertQuery("SHOW STATS FOR (SELECT * FROM nation_partitioned WHERE regionkey < 1)",
                new StringBuilder().append("SELECT * FROM (VALUES ").append("   ('regionkey', null, 1.0, 0.0, null, 0, 0), ").append("   ('nationkey', null, 5.0, 0.0, null, 0, 16), ").append("   ('name', 37.0, 5.0, 0.0, null, null, null), ").append("   ('comment', 310.0, 5.0, 0.0, null, null, null), ").append("   (null, null, null, null, 5.0, null, null))").toString());
