...
{
    private static final Logger logger = LoggerFactory.getLogger(BingTileFunctions.class);
    ...
    private static final String LATITUDE_OUT_OF_RANGE = new StringBuilder().append("Latitude must be between ").append(MIN_LATITUDE).append(" and ").append(MAX_LATITUDE).toString();
    ...
    private static final String LONGITUDE_OUT_OF_RANGE = new StringBuilder().append("Longitude must be between ").append(MIN_LONGITUDE).append(" and ").append(MAX_LONGITUDE).toString();
    ...
    private static final String QUAD_KEY_TOO_LONG = new StringBuilder().append("QuadKey must be ").append(MAX_ZOOM_LEVEL).append(" characters or less").toString();
